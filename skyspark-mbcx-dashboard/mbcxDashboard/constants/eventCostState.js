/**
 * eventCostState.js — Runtime mutable state for Event Cost (MBCx Dashboard)
 * Requires: constants/eventCostConfig.js loaded first.
 */

window.mbcxDashboard = window.mbcxDashboard || {};
window.mbcxDashboard.eventCost = window.mbcxDashboard.eventCost || {};

var _cfg = window.mbcxDashboard.eventCost.config;

window.mbcxDashboard.eventCost.state = {
...
window.mbcxDashboard.eventCost.computeScaling = function() {
  var vh = window.innerHeight;
  var s = window.mbcxDashboard.eventCost.state.responsiveScaling;

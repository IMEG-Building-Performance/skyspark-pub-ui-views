...
window.mbcxDashboard.components.Compliance = (function () {
  ...
  function _loadEquipTable() {
    ...
    var axon = 'view_complianceSummary_Equiptable(readById(' + siteRef + ').toEquips, ' + dates + ')';
  ...
  function _loadEquipPlot() {
    ...
    var axon = 'view_complianceDashboard_equipPlot(readById(' + siteRef + ').toEquips, ' + dates + ', "' + equipName + '", "Compliance by Space", ' + rollup + ')';

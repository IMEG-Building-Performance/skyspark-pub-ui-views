...
window.mbcxDashboard.eventCost.monthlyOverview = {};

window.mbcxDashboard.eventCost.monthlyOverview.render = function(container, eventSummaries, onSelectEvent) {
  ...
  function buildChart() {
    ...
    loader.loadChartJs(function() {
      ...
      window._ecMonthlyChart = new Chart(chartCanvas.getContext('2d'), {
        type: 'bar',

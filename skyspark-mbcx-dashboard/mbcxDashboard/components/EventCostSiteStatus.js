...
window.mbcxDashboard.eventCost.siteStatus = {};

window.mbcxDashboard.eventCost.siteStatus.render = function(container, onChartReady) {
  var state        = window.mbcxDashboard.eventCost.state;
  var interactions = window.mbcxDashboard.eventCost.interactions;
  var annotations  = window.mbcxDashboard.eventCost.annotations;
  var timeline     = window.mbcxDashboard.eventCost.timeline;
  var chart        = window.mbcxDashboard.eventCost.chart;
  var loader       = window.mbcxDashboard.eventCost.loader;
  ...
  expandBtn.onclick = function() {
    if (window.mbcxDashboard.eventCost.expandView) {
      window.mbcxDashboard.eventCost.expandView.open(state, interactions, annotations, timeline, chart);
    }
  };
  ...
  loader.loadChartJs(function() {
    ...
    window.addEventListener('resize', function() {
      window.mbcxDashboard.eventCost.computeScaling();

...
(function () {
  ...
  var modules = [
    ...
    { src: 'constants/eventCostConfig.js' },
    { src: 'constants/eventCostState.js' },
    { src: 'utils/eventCostAxon.js' },
    { src: 'utils/eventCostTransformers.js' },
    { src: 'utils/eventCostInteractions.js' },
    { src: 'utils/eventCostChartLoader.js' },
    { src: 'utils/eventCostRendering.js' },
    { src: 'evals/loadEventCostData.js' },
    { src: 'fixtures/eventCostGenerators.js' },
    { src: 'components/EventCostMonthly.js' },
    { src: 'components/EventCostReconciliation.js' },
    { src: 'components/EventCostDetail.js' },
    { src: 'components/EventCostSiteStatus.js' },
    { src: 'components/EventCostDocs.js' },
    { src: 'components/EventCostExpandView.js' },
    { src: 'components/EventCostCalc.js' },
    { src: 'App.js' },

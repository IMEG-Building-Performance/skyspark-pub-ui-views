...
window.EventCostV2.expandView = {};

/**
 * Open the expanded chart view.
 * Rebuilds the chart at fullscreen size with event visibility toggles.
 */
window.EventCostV2.expandView.open = function(state, interactions, annotations, timeline, chart) {
  // ── Backdrop overlay ─────────────────────────────────────────────
  ...
  var expS = (window.EventCostV2.state.responsiveScaling || {}).vhScale || 1.0;

...
window.EventCostV2.tooltips = {};

/**
 * Draw bold marker on hovered annotation
 */
window.EventCostV2.tooltips.drawHoverMarker = function(ctx, chartInstance, xPixel, event) {
 ...
 */
window.EventCostV2.tooltips.wrapText = function(ctx, text, maxWidth) {
 ...
 */
window.EventCostV2.tooltips.drawRichTooltip = function(ctx, event, mouseX, mouseY, chartArea) {
  var s = (window.EventCostV2.state.responsiveScaling || {}).vhScale || 1.0;
  ...
  var titleLines = window.EventCostV2.tooltips.wrapText(ctx, event.label, width - (padding * 2));

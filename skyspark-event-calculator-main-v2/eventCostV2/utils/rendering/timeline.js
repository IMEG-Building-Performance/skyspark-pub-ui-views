 ...
 */
window.EventCostV2.timeline.detectTimelineClick = function(mouseX, mouseY, events, chartInstance) {
  ...
  var timelineCanvas = window.EventCostV2.state.timelineCanvas;
  ...
  // Calculate lane info
  var laneInfo = window.EventCostV2.timeline.calculateEventLanes(events);
 ...
 */
window.EventCostV2.timeline.calculateEventLanes = function(events) {
  var lanes = [];
 ...
 */
window.EventCostV2.timeline.drawTimeline = function(timelineCanvas, chartInstance, events) {

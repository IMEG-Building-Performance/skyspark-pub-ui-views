 ...
 * Stores the chart instance in window.EventCostV2.state.chartInstance.
 */

window.EventCostV2 = window.EventCostV2 || {};
window.EventCostV2.chart = {};
 ...
 */
window.EventCostV2.chart.createChart = function(canvas, utilityData, events, dateRange) {
  // Destroy existing chart if it exists
  if (window.EventCostV2.state.chartInstance) {
    window.EventCostV2.state.chartInstance.destroy();
  }

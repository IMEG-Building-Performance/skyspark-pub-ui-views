...
window.EventCostV2.labels = {};

/**
 * Calculate optimal label positions to avoid overlaps
 * Supports both point events and time-span events
 */
window.EventCostV2.labels.calculateLabelPositions = function(events, xScale, chartArea) {
 ...
 */
window.EventCostV2.labels.drawAnnotationLabel = function(ctx, xPixel, labelPos, labelText, color, chartArea, isHovered) {
  var s = (window.EventCostV2.state.responsiveScaling || {}).vhScale || 1.0;

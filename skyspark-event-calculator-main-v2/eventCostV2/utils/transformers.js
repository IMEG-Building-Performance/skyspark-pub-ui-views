...
window.EventCostV2.transformers = {};
 ...
 */
window.EventCostV2.transformers.transformEventsToChartFormat = function(skysparkEvents) {
  var colors = [
 ...
 */
window.EventCostV2.transformers.transformTableEventsToChartFormat = function(tableEvents) {
  var colors = [
    'rgba(54, 162, 235, 0.8)',   // Blue
    'rgba(255, 99, 132, 0.8)',   // Red
    'rgba(75, 192, 192, 0.8)',   // Teal
